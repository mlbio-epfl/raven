...
class RLHFArguments:
    ...
    ens: Optional[bool] = field(
        default=False,
        metadata={"help": "Use adaptive weights for training."},
    )
    edl: Optional[bool] = field(
        default=False,
        metadata={"help": "Extract logprobs for EDL weak models."},
    )
    ens_lr: float = field(
        default=0,
        metadata={"help": "LR for adaptive weights."},
    )
    easy_hard: float = field(
        default=0,
        metadata={"help": "easy hard schedule ratio."},
    )
    weight_ver: int = field(
        default= 2,
        metadata={"help": "Ensemble Weight Version"},
    )
...
class FinetuningArguments(
    ...
    loss: str = field(
        default="xent",
        metadata={"help": "type of loss to use for text classification"},
    )
    label_mode: str = field(
        default="gt",
        metadata={"help": "gt, weak, ens, etc."},
    )
    gamma: float = field(
        default=0.5,
        metadata={"help": "gamma for edl"},
    )
    lambdas: str = field(
        default="_1_1_1",
        metadata={"help": "lambdas for edl"},
    )
    linear_probe: bool = field(
        default=False,
        metadata={"help": "Use linear probe for text classification."},
    )
    target_train: bool = field(
        default=False,
        metadata={"help": "Train with the target dataset"},
    )
    mowm: bool = field(
        default=False,
        metadata={"help": "Mixture of Weak Models"},
    )
    extract: bool = field(
        default=False,
        metadata={"help": "Extract features"},
    )
    def __post_init__(self):
        ...
        self.disable_shuffling = True if self.easy_hard > 0 else False
