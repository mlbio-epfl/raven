...
def run_exp(args: Optional[Dict[str, Any]] = None, callbacks: List["TrainerCallback"] = []) -> None:
    ...
    logger.info_rank0(f"seed: {training_args.seed}")
    seed_all(training_args.seed)
    training_args.output_dir += f"_s{training_args.seed}"
    ...
    if finetuning_args.stage == "tc":
        run_tc(model_args, data_args, training_args, finetuning_args, callbacks)
