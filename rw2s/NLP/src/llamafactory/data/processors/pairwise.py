...
def _encode_pairwise_example(
    ...
    #weak_logits: Sequence[Sequence[float]],
    template: "Template",
    ...
    # chosen_logits = weak_logits[0]
    # rejected_logits = weak_logits[1]
...
def preprocess_pairwise_dataset(
    ...
    for i in range(len(examples["_prompt"])):
        ...
        chosen_input_ids, chosen_labels, rejected_input_ids, rejected_labels = _encode_pairwise_example(
            ...
            #eak_logits=examples["weak_logits"] if "weak_logits" in examples else [],
            template=template,
            tokenizer=tokenizer,
            processor=processor,
        ...
        if 'weak_logits' in examples: model_inputs["weak_logits"].append(examples['weak_logits'][i])
    return model_inputs
...
def print_pairwise_dataset_example(example: Dict[str, List[int]], tokenizer: "PreTrainedTokenizer") -> None:
    ...
    if "weak_logits" in example: print(example["weak_logits"])